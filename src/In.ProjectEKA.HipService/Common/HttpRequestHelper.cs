...
namespace In.ProjectEKA.HipService.Common
{
    ...
    public static class HttpRequestHelper
    {
        ...
        public static HttpRequestMessage CreateHttpRequestForDataPush<T>(
            HttpMethod method,
            string url,
            T content,
            string token,
            ...
            )
        {
            ...
            if (content != null)
            {
                ...
                httpRequestMessage.Content = new StringContent(json, Encoding.UTF8, contentType ?? MediaTypeNames.Application.Json);
            }
